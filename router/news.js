...
const { validator, result, validatorFile } = require('../middleware/validator');

router.post('/create', uploads.single('thumbnail'), validator, result, validatorFile, createNews);
